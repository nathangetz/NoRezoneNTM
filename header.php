...
<html>
    <head>
        ...
        <meta name="Keywords" content="No Rezone NTM, No Rezone North Table Mountain, north table mountain rezoning">
        <meta name="Description" content="No Rezone NTM | NexMetro Communities has proposed the re-zoning of 26 acres of land at the base of North Table Mountain to build a 235 unit high-density rental development. The negative impact with be far reaching.">
    ...
    <body class="d-flex w-100 h-100 flex-column" data-spy="scroll" data-target="#navbar" data-offset="100">
        <?php function active($page) {
            global $PageTitle;
